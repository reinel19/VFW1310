...
// in simulator we redefine to format for Rodas_Reinel_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.rodas_reinel_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rodas_reinel_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRodas_Reinel_Project1NativeItemNone = -1, 
	UIRodas_Reinel_Project1NativeItemSpinner = -2,
	UIRodas_Reinel_Project1NativeItemProgressBar = -3,
	
	UIRodas_Reinel_Project1NativeItemSlider = -4,
	UIRodas_Reinel_Project1NativeItemSwitch = -5,
	UIRodas_Reinel_Project1NativeItemMultiButton = -6,
	UIRodas_Reinel_Project1NativeItemSegmented = -7,
	
	UIRodas_Reinel_Project1NativeItemTextView = -8,
	UIRodas_Reinel_Project1NativeItemTextField = -9,
	UIRodas_Reinel_Project1NativeItemSearchBar = -10,
	
	UIRodas_Reinel_Project1NativeItemPicker = -11,
	UIRodas_Reinel_Project1NativeItemDatePicker = -12,
	
	UIRodas_Reinel_Project1NativeItemInfoLight = -13,
	UIRodas_Reinel_Project1NativeItemInfoDark = -14,
	
	UIRodas_Reinel_Project1NativeItemDisclosure = -15,
	
	UIRodas_Reinel_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Rodas_Reinel_Project1 instances of
