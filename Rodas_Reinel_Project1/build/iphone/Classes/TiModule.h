...
/**
 The base class for all Rodas_Reinel_Project1 modules
 */
...
/**
 Rodas_Reinel_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Rodas_Reinel_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Rodas_Reinel_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Rodas_Reinel_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Rodas_Reinel_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
