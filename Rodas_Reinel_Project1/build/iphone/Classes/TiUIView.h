...
/**
 Base class for all Rodas_Reinel_Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Rodas_Reinel_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
