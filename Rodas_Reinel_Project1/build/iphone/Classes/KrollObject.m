...
//@interface Rodas_Reinel_Project1Object : NSObject
//@end

@interface Rodas_Reinel_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Rodas_Reinel_Project1Object class]])
		{
			for (NSString *key in [[(Rodas_Reinel_Project1Object*)o modules] allKeys])
			{
