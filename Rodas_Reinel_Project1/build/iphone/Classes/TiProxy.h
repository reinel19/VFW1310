...
//Rare exceptions to indicate a bug in the _rodas_reinel_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Rodas_Reinel_Project1 proxies.
 */
