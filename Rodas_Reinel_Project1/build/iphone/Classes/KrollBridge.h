...
@interface Rodas_Reinel_Project1Object : KrollCoverageObject {
#else
@interface Rodas_Reinel_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Rodas_Reinel_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Rodas_Reinel_Project1Object *_rodas_reinel_project1;
    KrollObject* console;
	BOOL shutdown;
